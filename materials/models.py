...
class Сourse(models.Model):
    ...
    owner = models.ForeignKey('users.User', on_delete=models.SET_NULL, null=True, blank=True, related_name="user_course", verbose_name="Владелец курса")
...
class Lesson(models.Model):
    ...
    owner = models.ForeignKey('users.User', on_delete=models.SET_NULL, null=True, blank=True, related_name="user_lesson", verbose_name="Владелец урока")
