...
from .views import UserCreateAPIView, PaymentListAPIView, PaymentRetrieveAPIView, PaymentCreateAPIView, PaymentUpdateAPIView, PaymentDestroyAPIView
...
urlpatterns = [
    ...
    path('refresh/', TokenRefreshView.as_view(permission_classes = [AllowAny,]), name='refresh'),
]
