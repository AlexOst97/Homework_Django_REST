...
## Настройка сервера:
1. Войдите в систему виртуальной машины для настройки сервиса: *ssh test@84.201.149.218*
...
8. Доступ приложения: *http://84.201.149.218/*

## Инструкция по запуску проекта локально:
1. Клонируйте репозиторий: *https://github.com/AlexOst97/Homework_Django_REST*
2. Установка зависимостей проекта: *pip install -r requirements.txt*
3. Активация виртуального окружения: *.\venv\Scripts\activate*
4. Запуск миграций: *python manage.py migrate*
5. Запуск сервера: *python manage.py runserver*
6. Доступ приложения: *http://localhost:8000*
